...
public class HexUtil {
	...
	private static boolean logDEBUG = false;//Logger.logger.instanceShouldLog(Logger.DEBUG,HexUtil.class);
	...
	public final static byte[] bitsToBytes(BitSet ba, int size) {
		...
		//if(logDEBUG) Logger.debug(HexUtil.class, "bytes: "+bytesAlloc+" returned from bitsToBytes("+ba+ ',' +size+"): "+bytesToHex(b)+" for "+sb.toString());
		return b;
	}
