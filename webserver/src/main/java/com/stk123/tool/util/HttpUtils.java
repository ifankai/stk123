...
public class HttpUtils {
	...
	static{
		...
		proxys.add(null);
		proxys.add(new HttpUtils.Proxy("116.236.216.116",8080));
		proxys.add(new HttpUtils.Proxy("218.92.227.165",29786));
		proxys.add(new HttpUtils.Proxy("36.250.74.88",8101));
		proxys.add(null);
		proxys.add(new HttpUtils.Proxy("183.207.228.8",80));
		proxys.add(new HttpUtils.Proxy("220.248.41.106",110));
		proxys.add(new HttpUtils.Proxy("218.92.227.165",21571));
		proxys.add(null);
		proxys.add(new HttpUtils.Proxy("113.105.224.87",80));
    ...
    public static String get(String url, Map<String, String> params, Map<String, String> requestHeaders, String enc) throws Exception {
    	return HttpUtils.get(url, params, requestHeaders, enc, NO_OF_RETRY);
    }
    ...
    public static String get(String url, Map<String, String> reqParams, Map<String, String> requestHeaders, String enc, int tryTimes) throws Exception {
    	...
    	while(tryTimes > 0){
    		try{
    			...
    			return HttpUtils.get0(url, reqParams, requestHeaders, enc);
    		}catch(Exception e){
	...
	public static void main(String[] arg) throws Exception {
		...
		System.out.println(HttpUtils.getFileNameByUrl("http://js.xueqiu.com/images/face/21lol.png","utf-8"));
		HttpUtils.download("http://js.xueqiu.com/images/face/21lol.png", "d:\\share\\download\\");
