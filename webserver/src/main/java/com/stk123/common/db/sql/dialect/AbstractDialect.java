 ...
 *
 */
package com.stk123.common.db.sql.dialect;
...
import com.stk123.common.db.Cell;
import com.stk123.common.db.Column;
import com.stk123.common.db.Row;
import com.stk123.common.db.sql.Dialect;
import com.stk123.common.db.sql.type.BigDecimalSQLDataType;
import com.stk123.common.db.sql.type.BlobSQLDataType;
import com.stk123.common.db.sql.type.BooleanSQLDataType;
import com.stk123.common.db.sql.type.ByteSQLDataType;
import com.stk123.common.db.sql.type.BytesSQLDataType;
import com.stk123.common.db.sql.type.CalendarSQLDataType;
import com.stk123.common.db.sql.type.ClobSQLDataType;
import com.stk123.common.db.sql.type.DateSQLDataType;
import com.stk123.common.db.sql.type.DoubleSQLDataType;
import com.stk123.common.db.sql.type.FloatSQLDataType;
import com.stk123.common.db.sql.type.IntegerSQLDataType;
import com.stk123.common.db.sql.type.LongSQLDataType;
import com.stk123.common.db.sql.type.ShortSQLDataType;
import com.stk123.common.db.sql.type.StringSQLDataType;
import com.stk123.common.db.sql.type.TimeSQLDataType;
import com.stk123.common.db.sql.type.TimestampSQLDataType;
...
public abstract class AbstractDialect implements Dialect {
	...
	protected void regSystemTypes(){
		...
		sqlTypes.put(com.stk123.common.db.sql.lob.TranClob.class.getName(), ClobSQLDataType.class) ;
		
		//blob
		sqlTypes.put("blob", BlobSQLDataType.class) ;
		sqlTypes.put(java.sql.Blob.class.getName(), BlobSQLDataType.class) ;
		sqlTypes.put(com.stk123.common.db.sql.lob.TranBlob.class.getName(), BlobSQLDataType.class) ;
