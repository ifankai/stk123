...
alter table stk_report_detail add output_1 varchar2(4000);
alter table stk_report_detail add output_2 varchar2(2000);
alter table stk_report_detail add checked_time date;
alter table stk_report_detail add output_volume_highest varchar2(2000); --量能创历史新�?
alter table stk_report_detail add output_down_longtime varchar2(2000); --从高点调整很久（大于24�?120天）
...
delete from stk_report_header where report_date='20211025';
delete from stk_report_detail where header_id in (select id from stk_report_header where report_date='20211025')
...
select * from stk_report_detail where id=10022;
