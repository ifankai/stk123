...
alter table stk add market number(1); --1：A股 2：美股 3:港股 5：外�?
...
alter table stk_report_detail add output_down_longtime varchar2(2000); --从高点调整很久（大于24周120天）
alter table stk_report_detail add output_3 varchar2(4000);  -- 量能比大于3
