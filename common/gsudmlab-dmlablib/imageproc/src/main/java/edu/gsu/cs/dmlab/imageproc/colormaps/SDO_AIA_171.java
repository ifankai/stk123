 ...
 * 
 */
public class SDO_AIA_171 extends ColorMap {

	static final double r[] = { 0, 0.146759, 1.0, 1.0, 1.0 };
	static final double g[] = { 0, 0.102798, 0.691436, 0.745824, 1.0 };
	static final double b[] = { 0, 0, 0, 0, 1.0 };

	static final double idx[] = { 0.0, 0.102668, 0.691448, 0.745625, 1.0 };

	public SDO_AIA_171() throws InvalidConfigException {
		super();
		this.init(256);
	}
