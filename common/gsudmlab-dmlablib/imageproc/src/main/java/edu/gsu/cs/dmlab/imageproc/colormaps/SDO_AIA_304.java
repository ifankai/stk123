 ...
 * 
 */
public class SDO_AIA_304 extends ColorMap {

	static final double r[] = { 0, 0.681458, 1.0, 1.0, 1.0, 1.0 };
	static final double g[] = { 0, 0, 0.415584, 0.517986, 0.807577, 1.0 };
	static final double b[] = { 0, 0, 0, 0, 0.602750, 1.0 };

	static final double idx[] = { 0.0, 0.471587, 0.691482, 0.745744, 0.899158, 1.0 };

	public SDO_AIA_304() throws InvalidConfigException {
		super();
		this.init(256);
	}
