 ...
 * 
 */
public class SDO_AIA_131 extends ColorMap {

	static final double r[] = { 0, 0, 0, 0.415553, 1.0 };
	static final double g[] = { 0, 0.142988, 0.681320, 1.0, 1.0 };
	static final double b[] = { 0, 0.142987, 0.681321, 1.0, 1.0 };

	static final double idx[] = { 0.0, 0.1, 0.471590, 0.691403, 1 };

	public SDO_AIA_131() throws InvalidConfigException {
		super();
		this.init(256);
	}
