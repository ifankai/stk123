 ...
 * 
 */
public class SDO_AIA_1700 extends ColorMap {

	static final double r[] = { 0, 0.321823, 0.564304, 0.790148, 1.0 };
	static final double g[] = { 0, 0.0890576, 0.313305, 0.618689, 1.0 };
	static final double b[] = { 0, 0.0890575, 0.313305, 0.618689, 1.0 };

	static final double idx[] = { 0.0, 0.1, 0.315137, 0.619883, 1.0 };

	public SDO_AIA_1700() throws InvalidConfigException {
		super();
		this.init(256);
	}
