 ...
 * track fragments being of the same object, based on some model of motion. From
 * Kempton et. al
...
public interface ISTMotionModel {
	...
	/**
	 * Returns the probability of two track fragments being the same object based on
	 * some model of motion similarity.
	 * 
	 * @param leftTrack  The track fragment that is earlier in time.
	 * 
	 * @param rightTrack The track fragment that is later in time.
	 * 
	 * @return The probability of the two track fragments being from the same object
	 *         with range [0,1].
	 */
