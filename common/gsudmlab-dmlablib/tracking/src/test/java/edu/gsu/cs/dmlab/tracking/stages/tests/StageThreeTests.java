...
import edu.gsu.cs.dmlab.tracking.stages.StageThree;
...
public class StageThreeTests {
	...
	@Test
	public void testStageThreeThrowsOnNullSearchAreaProducer() throws IllegalArgumentException {
		...
		Assertions.assertThrows(IllegalArgumentException.class, () -> {
			...
			ISTProcessingStage baseStage = new StageThree(predictor, factory, tracksIdxr, evntIdxr, maxFrameSkip,
					numThreads);
		});
	}

	@Test
	public void testStageThreeThrowsOnNullEventTrackingFactory() throws IllegalArgumentException {
	...
	@Test
	public void testStageThreeThrowsOnNullTrackIndexer() throws IllegalArgumentException {
		ISTSearchAreaProducer predictor = mock(ISTSearchAreaProducer.class);
		ISTEventTrackingFactory factory = mock(ISTEventTrackingFactory.class);
	...
	@Test
	public void testStageThreeThrowsOnNullEventIndexer() throws IllegalArgumentException {
		ISTSearchAreaProducer predictor = mock(ISTSearchAreaProducer.class);
		ISTEventTrackingFactory factory = mock(ISTEventTrackingFactory.class);
		ISTTrackingTrajectoryIndexer tracksIdxr = mock(ISTTrackingTrajectoryIndexer.class);
	...
	@Test
	public void testStageThreeThrowsOnFrameSkipLessThanZero() throws IllegalArgumentException {
		ISTSearchAreaProducer predictor = mock(ISTSearchAreaProducer.class);
		ISTEventTrackingFactory factory = mock(ISTEventTrackingFactory.class);
		ISTTrackingTrajectoryIndexer tracksIdxr = mock(ISTTrackingTrajectoryIndexer.class);
		ISTTrackingEventIndexer evntIdxr = mock(ISTTrackingEventIndexer.class);
	...
	@Test
	public void testStageThreeThrowsOnNumThreadsLessThanNegOne() throws IllegalArgumentException {
		ISTSearchAreaProducer predictor = mock(ISTSearchAreaProducer.class);
		ISTEventTrackingFactory factory = mock(ISTEventTrackingFactory.class);
		ISTTrackingTrajectoryIndexer tracksIdxr = mock(ISTTrackingTrajectoryIndexer.class);
		ISTTrackingEventIndexer evntIdxr = mock(ISTTrackingEventIndexer.class);
	...
	@Test
	public void testStageThreeThrowsOnNumThreadsZero() throws IllegalArgumentException {
		ISTSearchAreaProducer predictor = mock(ISTSearchAreaProducer.class);
		ISTEventTrackingFactory factory = mock(ISTEventTrackingFactory.class);
		ISTTrackingTrajectoryIndexer tracksIdxr = mock(ISTTrackingTrajectoryIndexer.class);
		ISTTrackingEventIndexer evntIdxr = mock(ISTTrackingEventIndexer.class);
