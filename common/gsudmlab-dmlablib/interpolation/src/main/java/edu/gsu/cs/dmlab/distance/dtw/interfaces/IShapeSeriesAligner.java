 ...
 */
package edu.gsu.cs.dmlab.distance.dtw.interfaces;
...
public interface IShapeSeriesAligner {

	//public IAlignmentInfo getWarpInfoBetween(ITimeSeries tsI, ITimeSeries tsJ, ISearchWindow window);
