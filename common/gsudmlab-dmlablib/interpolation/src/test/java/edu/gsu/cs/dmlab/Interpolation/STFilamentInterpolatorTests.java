...
import edu.gsu.cs.dmlab.interpolation.STFilamentPolygonInterpolator;
...
class STFilamentInterpolatorTests {
	@Test
	void testConstructorThrowsOnNullAligner() {
		...
		IInterpolator arealInterpolator = mock(IInterpolator.class);
		ISTEndpointFinder endpointFinder = mock(ISTEndpointFinder.class);

		Assertions.assertThrows(IllegalArgumentException.class, () -> {
			new STFilamentPolygonInterpolator(factory, tsAlignFactory, aligner, tsAligner, multipolyValidator,
					simplifyValidator, arealInterpolator, endpointFinder, step);
		});
	}
	...
	void testInterpolateTrajectoryThrowsOnNullInputTrajectory() {
		...
		IInterpolator interp = new STFilamentPolygonInterpolator(factory, tsAlignFactory, aligner, tsAligner,
				multipolyValidator, simplifyValidator, arealInterpolator, endpointFinder, step);
		Assertions.assertThrows(IllegalArgumentException.class, () -> {
