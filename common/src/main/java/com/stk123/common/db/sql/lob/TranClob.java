 ...
 *
 */
package com.stk123.common.db.sql.lob;
...
import com.stk123.common.db.util.HexUtil;
...
public class TranClob implements Clob, Serializable {
	 ...
	 * @throws SQLException 
	 */
	public TranClob(Clob clob) throws SQLException{
		this(clob, true) ;
	}
	
	public TranClob(Clob clob, boolean loadedFromDB) throws SQLException{
		this.clob = clob ;
		this.hex = HexUtil.bytesToHex(getContent().getBytes());
